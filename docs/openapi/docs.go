...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_thecemakin_hr-project_internal_modules_corehr_model.OrganizationNode"
                            }
                        }
                    },
                    "500": {
    ...
    "definitions": {
        ...
        "github_com_thecemakin_hr-project_internal_modules_corehr_model.OrganizationNode": {
            "type": "object",
            "properties": {
                "department": {
                    "type": "string"
